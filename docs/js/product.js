...
// =============================================
// BOTÓN PARA BORRAR EL PRODUCTO (FUNCIONA 100%)
// =============================================
document.addEventListener("DOMContentLoaded", () => {
    ...
    // 👇 Encontrar producto actual dentro de los que creó el usuario
    const currentProduct = userProducts.find(p => String(p.id) === String(productId));

    // 👇 Mostrar botón SOLO si este producto fue creado por el usuario
    if (currentProduct) {
    ...
    deleteButton.addEventListener("click", () => {
        ...
        // Filtrar los productos del usuario, sacando el actual
        const updatedProducts = userProducts.filter(p => String(p.id) !== String(productId));
